    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sn', models.CharField(db_index=True, help_text='SN', max_length=80, verbose_name='SN')),
                ('rmt_card_ip', models.CharField(db_index=True, help_text='远程管理IP', max_length=15, null=True, unique=True, verbose_name='远程管理卡IP')),
                ('cabinet_position', models.CharField(help_text='机柜内位置', max_length=20, null=True, verbose_name='机柜内位置')),
                ('uuid', models.CharField(db_index=True, help_text='UUID', max_length=80, unique=True, verbose_name='UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(help_text='所在服务器', on_delete=django.db.models.deletion.CASCADE, to='servers.Server', verbose_name='所在服务器')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(help_text='所在服务器', on_delete=django.db.models.deletion.CASCADE, to='servers.NetworkDevice', verbose_name='所在网卡')),
            ],
            options={
